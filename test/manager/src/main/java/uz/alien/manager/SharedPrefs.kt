...
object SharedPrefs {
    ...
    */
    ...
    private const val MESSAGE = "SharedPrefs has not been initialized. Please init SharedPrefs in your Application class!!!"
    ...
    fun init(app: Application, prefsName: String) {

        preferences = app.getSharedPreferences(prefsName, Context.MODE_PRIVATE)
    }
